...
import kotlinx.android.synthetic.main.addplant.*
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>, grantResults: IntArray) {
        ...
        if (requestCode == REQUEST_GALLERY_CAMERA) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED && grantResults[1] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this@addPlantActivity, getString(R.string.permission_denied), Toast.LENGTH_SHORT).show()
            }
        }
    }
        ...
        if (resultCode == Activity.RESULT_OK) {
            when (requestCode) {
                CAMERA_REQUEST_CODE -> {
                    ...
                    plant1.setImageBitmap(imageBitmap)
