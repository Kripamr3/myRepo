...
import com.inapp.geomatrix.Dashboard_sideMenu
...
class SignupActivity : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _loginLink!!.setOnClickListener {
            ...
            finish()
//            overridePendingTransition(com.inapp.geomatrix.R.anim.push_left_in, com.kotlindroider.devaj.R.anim.push_left_out)
        }
    }
    ...
    fun signup() {
        ...
        val progressDialog = ProgressDialog(this@SignupActivity,
            com.inapp.geomatrix.R.style.AlertDialog_AppCompat_Light)
...
//        finish()
        startActivity(Intent(this, Dashboard_sideMenu::class.java))
        finish()
    }
